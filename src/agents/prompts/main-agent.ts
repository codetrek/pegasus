...
export function buildDelegationSection(): string[] {
  return [
    ...
    "",
    "**Critical: sub-agents start with a blank slate.** They cannot see your conversation",
    "history or previous results. The `input` field is their ONLY context — include all",
    "relevant information, data, and instructions they need. If you're asking a sub-agent",
    "to continue or build on earlier work, paste the relevant results into the input.",
    "",
